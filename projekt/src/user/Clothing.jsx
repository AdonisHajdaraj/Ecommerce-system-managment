...
const Clothing = () => {
  ...
  useEffect(() => {
    const fetchAllClothing = async () => {
      try {
        const [menRes, womenRes, kidsRes, menResHoodie, womenResHoodie, kidsResHoodie, menResPants, womenResPants, kidsResPants] = await Promise.all([
        ...
        const allProducts = [...menWithType, ...womenWithType, ...kidsWithType, ...menWithTypeHoodie, ...womenWithTypeHoodie, ...kidsWithTypeHoodie, ...menWithTypePants, ...womenWithTypePants, ...kidsWithTypePants];
  ...
  return (
    <div className="d-flex min-vh-100" style={{ backgroundColor: '#f0e6f6' }}>
      ...
      <div className="container mt-4">
        <h1 className="mb-4 text-center">Clothing Collection</h1>
