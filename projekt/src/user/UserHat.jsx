...
const UserHat = () => {
    ...
    }, [searchTerm, sortOption, hats]);

    const handleAddToCart = (hat) => {
        ...
        alert(`✅ "${hat.name}" u shtua në shportë!`);
    };
    ...
    return (
        <div className="d-flex min-vh-100" style={{ backgroundColor: '#F0F0F0' }}>
            ...
            <div className="container mt-4">
                <h1 className="mb-4 text-center">Hat Collection</h1>
