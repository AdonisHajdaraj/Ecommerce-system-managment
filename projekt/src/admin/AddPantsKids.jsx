...
const AddPantsKids = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3002/pantskids", formData, {
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <div className="card border-light shadow-lg rounded-3 p-4">
            <h3 className="text-center text-primary mb-4">Add New Pants</h3>
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="form-label">Pants Name</label>
                <input
                  type="text"
